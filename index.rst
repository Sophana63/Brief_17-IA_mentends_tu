.. Brief Audio documentation master file, created by
   sphinx-quickstart on Fri Jan 27 12:26:21 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Bienvenue - Brief 17 "IA m'entends-tu ?"
========================================

Contexte du projet
------------------

Vous êtes un-e jeune embauché-e au sein d'une entreprise experte en acoustique. Tous vos collègues sont acousticien-ne-s, mais peu d'entre eux maîtrisent l'intelligence artificielle. Il-elle-s vous fournissent toutes les formules dont vous avez besoin pour traiter les signaux acoustiques et les transformer en caractéristiques, mais il-elle-s comptent sur vous pour créer le code permettant de faire de la reconnaissance de sons à partir de leur travail.
